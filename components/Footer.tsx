      ...
      <div className="bg-dark-deep text-light rounded-t-[48px] sm:rounded-t-[64px]">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 py-16 sm:py-20 lg:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20">
            ...
            >
              <Link href="/" className="inline-block mb-4">
                <h3 className="font-display text-2xl text-white">
                  <span className="font-light">reels</span>
                  <span className="font-bold">.studio</span>
                </h3>
              </Link>
              <p className="text-sm text-white/50 leading-relaxed">
                The modern way to download Instagram Reels
              </p>
            </motion.div>
            ...
            >
              <h4 className="font-display font-bold text-xs uppercase tracking-widest text-white/40 mb-6">
                Product
              </h4>
                ...
                {['Features', 'How It Works'].map((link) => (
                  <li key={link}>
                    <Link
                      ...
                      className="text-white/70 hover:text-white text-sm font-display transition-colors inline-block"
                    >
                      {link}
                    </Link>
                  </li>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-white/10 hover:bg-primary flex items-center justify-center text-white hover:text-black transition-all duration-200"
